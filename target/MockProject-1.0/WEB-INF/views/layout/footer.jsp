        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-2 text-start my-5 d-grid h-25 ps-5 ">
                    <h5>BOOKZONE</h5>
                    <a href="/MockProject/home" class="text-decoration-none text-white mb-3">Home</a>
                    <a href="/MockProject/about_us" class="text-decoration-none text-white mb-3">About</a>
                    <a href="/MockProject_Main/book_list" class="text-decoration-none text-white mb-3">Shop</a>
                </div>
